package aplikacja.apka.resource;

import aplikacja.apka.enumeration.Status;
import aplikacja.apka.model.Response;
import aplikacja.apka.model.Server;
import aplikacja.apka.service.ServerService;
import aplikacja.apka.service.implementation.ServerServiceImplementation;
...
public class ServerResource {
    ...
    public ResponseEntity<Response> deleteServer(@PathVariable("idAddress") Long id){
        return ResponseEntity.ok(
                Response.builder()
                        .timeStamp(now())
                        .data(of("deleted", serviceImplementation.delete(id)))
